...
extern "C" { extern int   TextSys_WordFlags(int id);                           /* textsys.obj */ }
extern "C" { extern int   TextSys_WordX(int id);                               /* textsys.obj */ }
extern "C" { extern char *TextSys_Word(int id);                                /* textsys.obj */ }
