...
void HighExecute__15AIHigh_Opponent(AIHigh_Opponent *self);   /* :150 */
void * __15AIHigh_OpponentP8Car_tObj(AIHigh_Opponent *self, Car_tObj *carObj);   /* :250 */
int DoProvokedAttack__15AIHigh_Opponent(AIHigh_Opponent *self);   /* :260 */

#endif /* _GAME_COMMON_AIH_OPP_H_ */
