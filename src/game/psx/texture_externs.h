...
extern "C" { extern long  unpack(void *src, void *dst); }
extern "C" { extern long  unpacksize(void *src); }
           /* PsyQ libgpu */
                       /* PsyQ libgpu */
     /* PsyQ libgpu */
               /* shape lib */
                        /* shape lib */
                   /* shape lib */
extern "C" { extern char *Platform_GetDCTBuffer(int n, char *name); }
extern "C" { extern void  Texture_GetClutId(int id, int *xclut, int *yclut);  /* fwd (intra-module) */ }
