...
extern "C" { int   unpacksize(void *src);                 /* decompressed size */ }
extern "C" { void  unpack(void *src, void *dst);          /* shpsubs decompressor */ }
extern "C" { void  Texture_GetClutId(unsigned int bpp, int *xclut, int *yclut); }
   /* upload to VRAM */
}
#endif
