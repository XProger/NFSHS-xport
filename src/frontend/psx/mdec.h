...
extern "C" {
#endif
intptr_t initmdec(int width, int height, int bpp, int memtype); /* :92 retail INT; pointer carrier */
void restoremdec(intptr_t handle);                              /* :180 EXT FCN VOID */
void mdec(intptr_t handle, char *src, int x, int y);            /* :295 EXT FCN VOID */
int  mdecdone(intptr_t handle);                                 /* :381 EXT FCN INT  */
#ifdef __cplusplus
}
#endif
