...
extern "C" { void  FETextRender_MenuTextPositionedJustifyFade(int idx, short x, short y, short j, short state, tMenuTextState st, tMenuTextType tt); }
...
extern "C" { void  FETextRender_WordWrapTextRGBJustify(char *s, RECT *r, int rgb, int j, int a, bool b); }
void  ScaleShapeExtended(int a, int b, int c, int d, int e, int f, tDrawShapeExtended *ext);
extern "C" { void  DrawShapeExtended(int a, int b, int c, int d, int e, int f, tDrawShapeExtended *ext); }
...
extern "C" { BOOL IsShapeFileLoaded(tScreen *s, tShapeInformation *shp); }
