/* frontend/common/screencongrats.h - reconstructed decls for ScreenCongrats.obj (C++ TU) */
#ifndef _FE_SCREENS_SCREENCONGRATS_H_
#define _FE_SCREENS_SCREENCONGRATS_H_
