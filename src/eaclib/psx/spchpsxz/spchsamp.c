...
extern "C" int  iSPCH_UnPackSample(intptr_t bank, unsigned int sampleIdx,
                                    int *out); /* @0x8010B5D4 */
...
extern "C" int iSPCH_UnPackSample(intptr_t bank, unsigned int sampleIdx, int *out)
{
    int            ret  = 0;
    bool           done = false;
    int           *pp;
