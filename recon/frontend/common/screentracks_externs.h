...
void VIDEO_abortplayback(intptr_t h);
void VIDEO_destroy(intptr_t h);

/* --- PsyQ / syslib --- */

/* --- FE draw / text / effect --- */
extern "C" { void  DrawShape_NFS4RoundRectangle(int textValue, RECT *r, short s); }
...
extern "C" { void  Decrement(tListIteratorTrack *it, tPlayer p); }
